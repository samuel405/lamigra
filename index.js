...
//   return await mysqlDb.select().from('studios');
// }
...
let actors = require('./data/raw/actors');
let episodes = require('./data/raw/episodes');
let film_actors = require('./data/raw/film_actors');
let films_list = require('./data/raw/films_list');
let films = require('./data/raw/films');
let studios = require('./data/raw/studios');
let tv_shows_actors = require('./data/raw/tv_shows_actors');
let tv_shows_list = require('./data/raw/tv_shows_list');
let tv_shows = require('./data/raw/tv_shows');
let users = require('./data/raw/users');
